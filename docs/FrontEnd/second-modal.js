...
INPUT_PICTURE.addEventListener("change", function () { // l'événement de changement est capturé par l'écouteur d'événements associé
    if (this.files[0].size > 4194304) {
        alert("Fichier trop volumineux");
        this.value = "";
    }
    if (this.files[0]) {
        PICTURE_PREVIEW.src = URL.createObjectURL(this.files[0]); //et les éléments
        // d'affichage sont ajustés en conséquence pour masquer la sélection de photo et afficher l'aperçu 
